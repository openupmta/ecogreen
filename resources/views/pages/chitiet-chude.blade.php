    ...
    <main>
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <h3 class="title-sk-ct">{{ $detail->name }}</h3>
                <div class="row">
...
{{-- 
                    ...
                    @foreach ($detail->healths as $item)
                        
                   
                     <div class="col-md-4 img-sk-ct mb-5">
                         <a href="details/{{ $item->slug }}.html">
                        <img src="images/{{ $item->image }}" alt="" class="img_tuvansuckhoe">
                    </a>
					</div>
					<div class="col-md-8 text-ct-sp mb-5">
                        <h2><a href="details/{{ $item->slug }}.html" style="float:none">{{ $item->title }}</a></h2>
                        <p>{{ $item->summary }}</p>
						<a href="details/{{ $item->slug }}.html">Xem Tiếp <i class="fas fa-angle-double-right"></i></a>
                    </div>
                    @endforeach
