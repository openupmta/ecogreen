        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="product-grid6">
                    ...
                    <ul class="social">
                        <li><a href="{{route('chi-tiet-san-pham')}}" data-tip="Xem nhiều hơn"><i
                                    class="fa fa-search"></i></a></li>
                        <li><a href="{{route('chi-tiet-san-pham')}}" data-tip="Yêu thích"><i
                                    class="fa fa-shopping-bag"></i></a></li>
                        <li><a href="{{route('chi-tiet-san-pham')}}" data-tip="Thêm vào giỏ hàng"><i
