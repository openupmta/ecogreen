                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <a href="{{route('addshipping')}}" class="btn btn-success">Thêm</a>
                            </div>
                            <div class="box-header">
                                            ...
                                            <td>
                                                ...
                                                <div id="button{{$value->id}}">
                                                    ...
                                                    <a class="btn btn-danger"
                                                       href="{{route('deleteshipping',['id'=>$value->id])}}"
