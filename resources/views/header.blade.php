        ...
        <div class="header-2" id="bg-light" style="z-index: 1000;">
            <div class="container">
                <ul class="nav main-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="{{route('khuyen-mai')}}">Khuyến mại</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('tu-van-suc-khoe')}}">Tư vấn <i class="fa fa-angle-down" aria-hidden="true" style="font-size: 14px"></i></a>
                        <ul class="sub-menu ">
                            <li><a href="{{route('tu-van-suc-khoe')}}"style="font-size: 18px" >HỎI ĐÁP - TƯ VẤN</a>
                            </li>
                            <li><a href="{{route('cauhoithuonggap')}}"style="font-size: 18px">CÂU HỎI THƯỜNG GẶP</a></li>
